...
function cutscene_change_position(_id,_x,_y){
	with _id
	{
		_id.x = _x;
		_id.y = _y;
...
function cutscene_change_variable(_id,_var,_value){
...
function cutscene_fade(_room,_duration,_color,_id,_x,_y){
	fade(_room,_duration,_color,_id,_x,_y);
	end_scene();	
}
	
function cutscene_fade_in(_duration,_color){
	fade_in(_duration,_color);
	//end_scene();	
}

function cutscene_fade_out(_duration,_color){
	fade_out(_duration,_color);
	//end_scene();	
}
...
function cutscene_text(_txt,_current_node)
{
	if !instance_exists(obj_textbox)
	{
		create_textbox(_txt,_current_node);
	}
	end_scene();
}
