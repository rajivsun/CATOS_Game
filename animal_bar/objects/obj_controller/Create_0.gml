...
//["哟！让我瞧瞧。这不是我们的大律师阿泰吗？",noone],
//["你这副狼狈不堪的样子，看来一直在打硬仗呢。",noone],
//["哎别提了，最近一直在忙一个\n客户的案子，搞得我心力憔悴。",obj_buck,"sad"],
//["阿泰，工作固然重要，\n但你也要照顾好自己啊。",noone],
//["我看你鹿角好像都有点暗淡了，\n你平时可是每天都好好保养的啊。",noone],
//["你说得对。我也意识到了，最近一直\n在寻找平衡，但案子太棘手了。",obj_buck,"sad"], 
//["那就找些时间给自己放松一下，\n让自己恢复精力。",noone],
//["是啊，我需要好好休息一下，\n充充电。",obj_buck],
//["不过你还是那么高大帅气，\n再加上那一对威武的鹿角。",noone],
//["嗨，别提了，你是不知道我的鹿角被门卡住多少次了。",obj_buck],
//["哈哈哈，就这样你还是要每天精心打理呢。",noone],
//["哎，没办法，谁叫我们雄鹿天生长着一对大角呢。",obj_buck],
//["你还记得你小学时候吗？",noone],
//["那时候你刚刚长角，满头都是红红的。",noone],
//["哈哈记得，因为我们刚长鹿角的时候会先长一层皮。",obj_buck],
//["等长成熟了之后这层皮才会脱落。",obj_buck],
//["嗯嗯，你跟我解释过。你们动物在\n某些方面确实和人类不太一样。",noone],

//["话说这次是啥案子啊，给我说说嘛。",noone],
//["这次是一宗很不寻常的失踪案，\n关于一对夫妻的。",obj_buck],
//["听起来挺有挑战性的，你对这个案子\n有信心吗？",noone],
//["当然有信心，只是这次案件确实很复杂。",obj_buck,"laugh"],
