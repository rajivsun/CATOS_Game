...
["在和他交谈后我很确定不是丈夫的责任。",obj_buck],
["只是最近出了一个对丈夫很不利的物证。",obj_buck],
...
txt2_2[0] = [
["哇，这不是我们小时候吗？你，我，还有小灰。",noone],
["这一晃20年过去了，时间过得真快。",noone],
["你最近还和小灰有联系吗？",obj_buck],
["他也有段时间没来了，前段时间他刚开了一家修车行。",noone],
["那挺好的，还好之前那件事没闹得太大，不然。。。",obj_buck],
["是啊，还好被打的那一方没有继续追究责任。",noone],
["具体是什么原因打架来的？我有点记不清了。",obj_buck],
["是小灰在路上看到一个河马在欺负一\n只小鹿，他直接上去就把河马咬了。",noone],
["河马有时候确实老是喜欢欺负别的动物，感觉就像是骨子里带的是的。",obj_buck],
["虽然我不喜欢刻板印象，但是确实大部分的河马挺霸道的。。。",noone],
["小灰人其实挺好的，也很仗义，就是有时候性格有点冲。",obj_buck],
[2,"door"],
];
...
all_txt = [txt,txt2,txt2_1,txt2_2,txt3,txt3_1,txt4,txt5,txt6];